...
public class PisciICitaoci extends Application {
	...
	protected final Operation pisanje = duration("5±2").text("Пише").container(resurs).textAfter("Завршио").update(this::azuriraj);;
	protected final Operation citanje = duration("5±2").text("Чита").container(resurs).textAfter("Завршио").update(this::azuriraj);;
	protected final Operation posao   = duration("7±2").text("Ради").textAfter("Чека");
